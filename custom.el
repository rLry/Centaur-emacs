...
(defun centaur-setup-fonts ()
  ...
  (when (display-graphic-p)
    ;; Set default font
    (cl-loop for font in '("Iosevka NF" "Cascadia Code" "Fira Code" "Jetbrains Mono"
    ...
    ;; Set mode-line font
    (cl-loop for font in '("Iosevka NF" "Menlo" "SF Pro Display" "Helvetica")
             ...
             return (progn
                      ...
                      (set-face-attribute 'help-key-binding nil :family font :height 120)
                       ))
    ...
    (cl-loop for font in '("LXGW WenKai Screen" "LXGW WenKai Mono" "PingFang SC" "Microsoft Yahei UI" "Simhei")
             when (font-installed-p font)
             return (progn
...
;; the default folder in Emacs
(setq default-directory "~/OneDrive/Notes/Org/" )
(setq centaur-org-directory (expand-file-name "~/OneDrive/Notes/Org/"))
